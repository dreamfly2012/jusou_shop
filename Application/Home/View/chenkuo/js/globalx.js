...
function getAllValues() {
    ...
    if (arguments.length > 0) itemsName = arguments[0];
    var reval = "";
    ...
    if (reval != "") reval = reval.substring(1);
    return reval;
}
//删除所有 插件
$.fn.deleteAll = function() {
    ...
    $this.click(function() {
        ...
        if (!itemsName) itemsName = "checkItem";
        ...
        var event, txt = "删除";
        if (args.length > 0) event = args[0];
        if (args.length > 1) txt = args[1];
        var arr = vals.split(",");
        showConfirm(txt + "确认", "真的要" + txt + "这 " + arr.length + " 条记录吗？",
        function() {
            if (event) {
                event(vals);
            }
...
$(function() {
    ...
    $(".checkAll").click(function() {
        ...
        $("input[name=" + itemsName + "]").each(function() {
            var $item = $(this);
            if ($this.attr("checked")) $item.attr("checked", "checked");
            else $item.removeAttr("checked", "checked");
        });
    });
...
/*邮箱输入提示*/
var MailTips = {
    mailArr: ["163.com", "126.com", "qq.com", "sina.com", "vip.sina.com", "hotmail.com", "gmail.com", "sina.cn", "suho.com", "yahoo.cn", "139.com", "wo.com.cn", "189.cn"],
    liArr: [],
    box: null,
    input: null,
    ...
    getLi: function() {
        ...
        this.addEvent(li, "mouseover",
        function() {
            li.className = "overli";
        });
        this.addEvent(li, "mouseout",
        function() {
            li.className = "outli";
        });
        this.addEvent(li, "click",
        function() {
            MailTips.input.value = li.innerHTML;
        });
        return li;
    },
...
Carousel.prototype = {
    ...
    move: function() {
        var self = this;
        $(self.sprite).stop().animate({
            "left": -self.index * self.space
        },
        "100");
    },
    getElem: function(id) {
